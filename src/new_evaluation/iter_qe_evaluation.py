...
def batch_evaluation(
    ...
    for i, result in enumerate(batch_eval_results):
        # query_feature = flatten_eval_query_features[global_idx + i]
        # query_answer = query_feature.get_query_answer()
        # query_type = query_feature.query_type
        # query_str = query_feature.format_str()
