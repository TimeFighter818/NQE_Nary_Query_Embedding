            ...
            while True:
                ...
                if line_data:
                    ...
                    for query_idx in new_dict:
                        # data[query_idx] = new_dict[query_idx]
                    # print(line_data)
    ...
    for run_type in run_type_ls:
        ...
        if run_type == "train":
            ...
            for task in tasks_ls:
                ...
                # all_query_features_ls.append(single_dataset)
            ...
            while True:
                ...
                if line_data:
                    ...
                    for query_idx in new_dict:
                        ...
                        if idx % 100 == 0:
                            logger.info("query %s - %d" % (self.query_type, idx) )
...
def get_dataloader_ls(data_reader_dict, run_type_ls, config):
    ...
    for run_type in run_type_ls:
        if run_type == "train":
            do_shuffle = config["train_shuffle"]
        else:
            do_shuffle = False
